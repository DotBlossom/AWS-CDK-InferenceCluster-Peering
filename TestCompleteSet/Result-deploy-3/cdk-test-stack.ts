...
export class CdkTestStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const ecsExecTaskPolicy = new iam.Policy(this, "ExecPolicy", { statements: [ecsExecTaskPolicyStatement] });
    (inferService.node.findChild('Service') as ecs.CfnService).enableExecuteCommand = true;
    inferService.taskDefinition.taskRole.attachInlinePolicy(ecsExecTaskPolicy);

// embedService에 ECS Exec 권한 추가
    (embedService.node.findChild('Service') as ecs.CfnService).enableExecuteCommand = true;
    embedService.taskDefinition.taskRole.attachInlinePolicy(ecsExecTaskPolicy);
